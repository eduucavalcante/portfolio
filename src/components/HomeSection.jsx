    ...
    return (
        <section id="Home">
            ...
            <div>
                <h2>
                    Olá, eu sou o<br />
                    <span className="Typewriter">Eduardo Cavalcante</span>
                </h2>
                <p>Desenvolvedor Full-Stack</p>
                <div id="social">
                    <a href="https://github.com/eduucavalcante" target='_blank'>
                    ...
                    <a href="https://www.linkedin.com/in/eduardo-cavalcante-dev" target='_blank'>
